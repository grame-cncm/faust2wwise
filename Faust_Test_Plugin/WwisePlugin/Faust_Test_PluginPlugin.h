...
class Faust_Test_PluginPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Faust_Test_PluginPlugin();
    ~Faust_Test_PluginPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(Faust_Test_Plugin);	// Exposes our PluginContainer structure that contains the info for our plugin
