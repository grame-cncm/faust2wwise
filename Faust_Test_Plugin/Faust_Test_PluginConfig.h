...
#ifndef Faust_Test_PluginConfig_H
#define Faust_Test_PluginConfig_H
...
namespace Faust_Test_PluginConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 29298;
}

#endif // Faust_Test_PluginConfig_H
