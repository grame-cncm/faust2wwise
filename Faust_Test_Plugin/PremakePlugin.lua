...
local Plugin = {}
Plugin.name = "Faust_Test_Plugin"
Plugin.factoryheader = "../SoundEnginePlugin/Faust_Test_PluginFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Faust_Test_Plugin.def",
    "Faust_Test_Plugin.xml",
    "**.rc",
}
