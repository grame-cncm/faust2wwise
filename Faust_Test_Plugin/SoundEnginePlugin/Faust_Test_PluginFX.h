...
#ifndef Faust_Test_PluginFX_H
#define Faust_Test_PluginFX_H

#include "Faust_Test_PluginFXParams.h"

#include "SimplifiedMonoEcho.h"
...
private:
    Faust_Test_PluginFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;

    SimplifiedMonoEcho m_dsp[2];
};

#endif // Faust_Test_PluginFX_H
