...
#ifndef Faust_Test_PluginFXParams_H
#define Faust_Test_PluginFXParams_H
...
struct Faust_Test_PluginRTPCParams
{
    AkReal32 fDelayTime;
    AkReal32 fFeedback;
};

struct Faust_Test_PluginNonRTPCParams
{
};

struct Faust_Test_PluginFXParams
    : public AK::IAkPluginParam
{
    Faust_Test_PluginFXParams();
    Faust_Test_PluginFXParams(const Faust_Test_PluginFXParams& in_rParams);
    ...
    Faust_Test_PluginRTPCParams RTPC;
    Faust_Test_PluginNonRTPCParams NonRTPC;
};

#endif // Faust_Test_PluginFXParams_H
