...
local Plugin = {}
Plugin.name = "Faust_Interpreter_Test_Plugin"
Plugin.factoryheader = "../SoundEnginePlugin/Faust_Interpreter_Test_PluginSourceFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "Faust_Interpreter_Test_PluginSourceShared.cpp",
    "Faust_Interpreter_Test_PluginSourceFactory.h",
    "../FaustInterpreter/**.cpp",
    "../FaustInterpreter/**.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Faust_Interpreter_Test_Plugin.def",
    "Faust_Interpreter_Test_Plugin.xml",
    "**.rc",
}
