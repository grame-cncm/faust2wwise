...
#ifndef Faust_Interpreter_Test_PluginConfig_H
#define Faust_Interpreter_Test_PluginConfig_H
...
namespace Faust_Interpreter_Test_PluginConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 16291;
}

#endif // Faust_Interpreter_Test_PluginConfig_H
