...
#ifndef Faust_Interpreter_Test_PluginSourceParams_H
#define Faust_Interpreter_Test_PluginSourceParams_H
...
struct Faust_Interpreter_Test_PluginRTPCParams
{
    AkReal32 fDuration;
};

struct Faust_Interpreter_Test_PluginNonRTPCParams
{
};

struct Faust_Interpreter_Test_PluginSourceParams
    : public AK::IAkPluginParam
{
    Faust_Interpreter_Test_PluginSourceParams();
    Faust_Interpreter_Test_PluginSourceParams(const Faust_Interpreter_Test_PluginSourceParams& in_rParams);
    ...
    Faust_Interpreter_Test_PluginRTPCParams RTPC;
    Faust_Interpreter_Test_PluginNonRTPCParams NonRTPC;
};

#endif // Faust_Interpreter_Test_PluginSourceParams_H
