...
bool Faust_Compiler_Test_PluginPluginGUI::SaveCodeEditorText()    // rename that to GetCodeEditorText
{
...
bool Faust_Compiler_Test_PluginPluginGUI::OnBuildButtonClicked(){
...
void Faust_Compiler_Test_PluginPluginGUI::ShowPopupWindow()
{
    MessageBoxW(faustWnd, L"Output not yet supported!", L"FAUST Code Output", MB_OK | MB_ICONINFORMATION);
}


bool Faust_Compiler_Test_PluginPluginGUI::loadLastSavedCode()
{
...
bool Faust_Compiler_Test_PluginPluginGUI::saveCurrentCodeState()
{
    std::filesystem::path codePath = tempDir / "last_code.dsp";
...
void Faust_Compiler_Test_PluginPluginGUI::debugPrint(std::wstring text, size_t len)
{
