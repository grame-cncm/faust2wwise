...
Plugin.factoryheader = "../SoundEnginePlugin/Faust_Compiler_Test_PluginFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "Faust_Compiler_Test_PluginFXShared.cpp"
}
...
Plugin.sdk.shared.files =
{
    ...
    "../FaustInterpreter/**.h",
    "Faust_Compiler_Test_PluginFXShared.cpp",
    "Faust_Compiler_Test_PluginFXFactory.h",
}
