...
#ifndef Faust_Compiler_Test_PluginFXParams_H
#define Faust_Compiler_Test_PluginFXParams_H
...
struct Faust_Compiler_Test_PluginFXParams
    : public AK::IAkPluginParam
{
    Faust_Compiler_Test_PluginFXParams();
    Faust_Compiler_Test_PluginFXParams(const Faust_Compiler_Test_PluginFXParams& in_rParams);
...
#endif // Faust_Compiler_Test_PluginFXParams_H
